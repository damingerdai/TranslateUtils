...
public final class PropertiesLoader {
	private AmingLogger logger = LoggerManager.getLogger(PropertiesLoader.class);
	...
	private String getValue(String key) {
		try {
			...
			logger.error("get {} fail: {} ", e.getMessage());
			throw new RuntimeException("get " + key + "fail: " + e.getMessage());
		}
	}
